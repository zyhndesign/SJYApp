...
- (void) setNavBtnSelectState:(BOOL)landBtnState Humanity:(BOOL)humanityBtnState Story:(BOOL)storyBtnState Community:(BOOL)communityState
{
    ...
    {
        [menuLandscapeBtn setTitleColor:[UIColor colorWithRed:227/255.0 green:130/255.0 blue:48/255.0 alpha:1] forState:UIControlStateNormal];
    ...
    {
        [menuHumanityBtn setTitleColor:[UIColor colorWithRed:227/255.0 green:130/255.0 blue:48/255.0 alpha:1] forState:UIControlStateNormal];
    ...
    {
        [menuStoryBtn setTitleColor:[UIColor colorWithRed:227/255.0 green:130/255.0 blue:48/255.0 alpha:1] forState:UIControlStateNormal];
        [menuHumanityBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuLandscapeBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuCommunityBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuLandscapeLabel setHidden:YES];
    ...
    {
        [menuCommunityBtn setTitleColor:[UIColor colorWithRed:227/255.0 green:130/255.0 blue:48/255.0 alpha:1] forState:UIControlStateNormal];
        [menuHumanityBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuStoryBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuLandscapeBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [menuLandscapeLabel setHidden:YES];
